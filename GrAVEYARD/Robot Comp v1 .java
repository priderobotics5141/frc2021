...
if(gamePad0.getRawButtonPressed(9)){ledState = !ledState;}

    if (ledState || doAutoPilotNow){table.getEntry("ledMode").setNumber(3);}
...
if(ultrasonic3.getRangeMM() !=0.0){
  if(ultrasonic3.getRangeMM() > 150){Ball3 = false;}
  else{ Ball3 = true; }
}
    ultrasonic1.ping();
    ultrasonic2.ping();
